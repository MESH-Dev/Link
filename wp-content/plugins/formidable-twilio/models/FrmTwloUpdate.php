...
class FrmTwloUpdate{
    ...
    function __construct(){
        ...
        $this->plugin_nicename      = 'formidable-twilio';
        $this->plugin_name          = 'formidable-twilio/formidable-twilio.php';
        $this->pro_last_checked_store = 'frm_twlo_last_checked_update';
